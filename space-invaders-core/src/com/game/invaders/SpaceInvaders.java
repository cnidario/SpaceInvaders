...
public class SpaceInvaders extends ApplicationAdapter {
	...
	public void create () {
		...
		EntityMapperFactory entityMapperFactory = new EntityMapperFactory(entityManager, eventSystem);
		EntityBuilderFactory entityBuilderFactory = new EntityBuilderFactory(entityManager, eventSystem);
		...
		processManager.addProcess(new CollisionSystem<CollisionGroup>(entityManager, entityBuilderFactory, entityMapperFactory));
